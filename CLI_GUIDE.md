...
For a graphical telemetry view, use the separate [dashboard setup and operation guide](DASHBOARD_SETUP.md).
...
- [SCV2 dashboard setup and operation](DASHBOARD_SETUP.md)
