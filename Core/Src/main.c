...
int main(void)
{
  ...
  if (HAL_FDCAN_ConfigInterruptLines(&hfdcan1, FDCAN_IT_GROUP_PROTOCOL_ERROR, FDCAN_INTERRUPT_LINE0) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  if (HAL_ADC_Start_DMA(&hadc2, (uint32_t *)g_adc2_dma_buf, 3) != HAL_OK)
  {
    Error_Handler();
  }
  __HAL_DMA_DISABLE_IT(&hdma_adc2, DMA_IT_TC | DMA_IT_HT);
  HAL_NVIC_ClearPendingIRQ(DMA1_Channel2_IRQn);
  HAL_NVIC_DisableIRQ(DMA1_Channel2_IRQn);

  if (HAL_ADC_Start_DMA(&hadc1, (uint32_t *)g_adc1_dma_buf, 2) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_FDCAN1_Init(void)
{
  ...
  /*
   * Accept only SUPERCAP_NODE_ID; reject everything else.
  ...
  filter.FilterID1 = SUPERCAP_NODE_ID;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_DIR_Pin|GPIO_RVSOFF_Pin|GPIO_MODELSB_Pin|GPIO_NSIL_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIO_LED_GPIO_Port, GPIO_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_SWEN_Pin|GPIO_MODEMSB_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : GPIO_RVSOFF_Pin */
  GPIO_InitStruct.Pin = GPIO_RVSOFF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIO_RVSOFF_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : GPIO_SWEN_Pin GPIO_MODEMSB_Pin GPIO_MODELSB_Pin GPIO_NSIL_Pin */
  GPIO_InitStruct.Pin = GPIO_SWEN_Pin|GPIO_MODEMSB_Pin|GPIO_MODELSB_Pin|GPIO_NSIL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
