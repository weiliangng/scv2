...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_DIR_Pin|GPIO_RVSOFF_Pin|GPIO_NSIL_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIO_LED_GPIO_Port, GPIO_LED_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_SWEN_Pin|GPIO_MODEMSB_Pin|GPIO_MODELSB_Pin, GPIO_PIN_RESET);
