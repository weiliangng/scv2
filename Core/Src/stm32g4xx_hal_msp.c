...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA1     ------> ADC1_IN2
    */
    GPIO_InitStruct.Pin = ADC1_IN1_Vcap_Pin|ADC1_IN2_Vbus_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOA, ADC1_IN1_Vcap_Pin|ADC1_IN2_Vbus_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  if(hdac->Instance==DAC1)
  {
    ...
    PA5     ------> DAC1_OUT2
    */
    GPIO_InitStruct.Pin = DAC1_1_IMONINP_Pin|DAC1_2_IMONINN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  if(hdac->Instance==DAC1)
  {
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, DAC1_1_IMONINP_Pin|DAC1_2_IMONINN_Pin);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA2     ------> OPAMP1_VOUT
    */
    GPIO_InitStruct.Pin = OPA1_DAC3_1_FBout_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OPA1_DAC3_1_FBout_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PB14     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = OPA2_IMONOP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OPA2_IMONOP_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(hopamp->Instance==OPAMP3)
  {
    ...
    PB13     ------> OPAMP3_VINP
    */
    GPIO_InitStruct.Pin = OPA3_IMONON_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(OPA3_IMONON_GPIO_Port, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA2     ------> OPAMP1_VOUT
    */
    HAL_GPIO_DeInit(OPA1_DAC3_1_FBout_GPIO_Port, OPA1_DAC3_1_FBout_Pin);
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PB14     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(OPA2_IMONOP_GPIO_Port, OPA2_IMONOP_Pin);
  ...
  else if(hopamp->Instance==OPAMP3)
  {
    ...
    PB13     ------> OPAMP3_VINP
    */
    HAL_GPIO_DeInit(OPA3_IMONON_GPIO_Port, OPA3_IMONON_Pin);
