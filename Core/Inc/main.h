...
#define GPIO_RVSOFF_Pin GPIO_PIN_3
#define GPIO_RVSOFF_GPIO_Port GPIOB
#define GPIO_SWEN_Pin GPIO_PIN_4
#define GPIO_SWEN_GPIO_Port GPIOB
#define GPIO_MODEMSB_Pin GPIO_PIN_5
#define GPIO_MODEMSB_GPIO_Port GPIOB
#define GPIO_MODELSB_Pin GPIO_PIN_6
#define GPIO_MODELSB_GPIO_Port GPIOB
#define GPIO_NSIL_Pin GPIO_PIN_7
#define GPIO_NSIL_GPIO_Port GPIOB
