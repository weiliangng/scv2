...
#define SCAP_VCAP_LOW_RATIO             (0.20f)
...
#define SCAP_ENERGY_ISR_BLOCK_SAMPLES        (50u)
...
#define SCAP_CAP_HEALTH_WINDOW_MS             (60000u)
#define SCAP_CAP_HEALTH_VOLTAGE_AVG_MS        (10000u)
#define SCAP_CAP_HEALTH_MIN_ENERGY_GAIN_MJ    (500000L)
#define SCAP_CAP_HEALTH_MAX_VOLTAGE_GAIN_MV   (100L)
#define SCAP_CAP_HEALTH_BAD_WINDOWS           (3u)
#define SCAP_VCAP_DERATE_STEP_V                (0.1f)
#define SCAP_VCAP_DERATE_MIN_V                 (23.0f)
